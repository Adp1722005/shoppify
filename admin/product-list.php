...
$sql = 'SELECT products.id, products.fname, products.description, categories.name
        FROM products
	...
	<div class="section center" style="padding: 20px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="../backends/admin/product-delete.php?id=<?php echo $key['id']; ?>"><span class="new badge" data-badge-caption="">Delete</span></a></td>
          </tr>
