			...
			<div class="col s12 m4">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/cat<?php echo $j; ?>.jpg" height="270px" width="250px">
				    </div>
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>This is a popular category of the Shoppify brand. Explore the Products of this category!</p>
			        </div>
				    </div>
