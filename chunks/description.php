<section class="fdes">
		<div class="section white center">
			<h2 class="header" style="padding:20px; padding-bottom: 30px;">Online shopping powered By Shoppify</h2>
		      <div class="row container center">
		        ...
		        <div class="col center l4 s12">
		        	<img height="300" width="auto" style="object-fit: contain;" src="images/slider3.jpg" alt="">
		        </div>
		      </div>
	</section>