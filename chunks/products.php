			...
			<div class="col s12 m4">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/prod<?php echo $j; ?>.jpg" height="400px" width="100px">
				    </div>
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>This is a popular product. Buy Now!</p>
			        </div>
			        <div class="card-content center">
			          <a href="backends/order-product.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #ee6e73;" class="btn waves-effect waves-block waves-light" href="">Buy Now!</a>
			        </div>
				    </div>
